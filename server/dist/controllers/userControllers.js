...
exports.verifyForgotMail =
  exports.sendForgotPasswordMail =
  exports.verifyUserMail =
      ...
      switch (_b.label) {
        ...
        case 2:
          ...
          if (existingUser)
            return [
              2 /*return*/,
              next((0, http_errors_1.default)(422, "Email Already Exist!")),
            ];
      ...
      switch (_b.label) {
        ...
        case 2:
          ...
          if (!user.isUserVerified)
            return [
              2 /*return*/,
              next((0, http_errors_1.default)(406, "User not Verified")),
            ];
          return [
            4 /*yield*/,
        ...
        case 3:
          ...
          if (!isValidPassword)
            return [
              2 /*return*/,
              next((0, http_errors_1.default)(401, "Not Valid Password!")),
            ];
...
var sendVerificationMail = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          if (!user)
            return [
              2 /*return*/,
              next((0, http_errors_1.default)(404, "Email Not Valid!")),
            ];
          if (user.isUserVerified)
            return [
              2 /*return*/,
              next((0, http_errors_1.default)(406, "User already verified")),
            ];
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            config_1.transporter.sendMail({
              from: '"Laadle" <gautamparmar@dashboardapp.com>',
              to: "".concat(email),
              subject: "For Email Verification",
              // text: "Hello world?", // plain text body
              html: 'Your Verification Link <a href="'
                .concat(config_1.FRONTEND_URL, "/email-verify/")
                .concat(jwtToken, '">Link</a>'), // html body
            }),
          ];
        case 4:
          info = _a.sent();
          ...
          return [
            4 /*yield*/,
            user.updateOne({ $set: { verifyToken: encryptedToken } }),
          ];
        case 5:
          // console.log("Preview URL: %s", nodemailer.getTestMessageUrl(info));
          _a.sent();
          res.json({
            message: "Preview URL: %s ".concat(
...
var verifyUserMail = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          if (!user)
            return [
              2 /*return*/,
              next((0, http_errors_1.default)(401, "Token Invalid")),
            ];
          return [
            4 /*yield*/,
            user.updateOne({
...
var sendForgotPasswordMail = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
        ...
        case 3:
          ...
          return [
            ...
            config_1.transporter.sendMail({
              ...
              // text: "Hello world?", // plain text body
              html: 'Your Verification for forgot password Link <a href="'
                .concat(config_1.FRONTEND_URL, "/forgot-password-verify/")
                .concat(jwtToken, '">Link</a>'), // html body
            }),
          ];
        case 4:
...
var verifyForgotMail = function (req, res, next) {
  return __awaiter(void 0, void 0, void 0, function () {
